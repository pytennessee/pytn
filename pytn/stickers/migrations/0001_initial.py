...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('stickers_sticker', (
            ...
            ('speaker', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stickers', to=orm['speakers.Speaker'])),
            ('upload', self.gf('django.db.models.fields.files.FileField')(max_length=100, blank=True)),
        ))
        db.send_create_signal('stickers', ['Sticker'])


    def backwards(self, orm):
        # Deleting model 'Sticker'
        db.delete_table('stickers_sticker')
    ...
    models = {
        ...
        'stickers.sticker': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'speaker': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'stickers'", 'to': "orm['speakers.Speaker']"}),
